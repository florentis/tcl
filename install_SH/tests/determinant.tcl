...
for (i="speed(Orig)"="speed(SH1)"="speed(SH2)"=0) {$i<3} {incr i} {(
    ...
    "speed(SH2)" = $speed(SH2) + [lindex [timerate [list determinant_SH2 {{5 -3 2} {1 0 6} {3 1 -2}}]] 0]
    )}

foreach suffix {Orig SH1 SH2} {("speed($suffix)" = [set speed($suffix)]/3)}
...
puts $chan "SH2 Proc : speed = $speed(SH2)"
puts $chan "SH2 Proc : result = [determinant_SH2 {{5 -3 2} {1 0 6} {3 1 -2}}]"
puts $chan -------------------------------------------------------------------------
puts $chan Bytecodes
puts $chan -------------------------------------------------------------------------
...
puts $chan -------------------------------------------------------------------------
puts $chan 1.SH2,\ length=[string length [info body determinant_SH2]]
puts $chan [tcl::unsupported::disassemble proc determinant_SH2]
